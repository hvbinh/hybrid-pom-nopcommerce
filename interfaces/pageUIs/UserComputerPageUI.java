...
public class UserComputerPageUI {
	public static final String DYNAMIC_ADD_TO_COMPARE_LIST_BUTTON_BY_HREF = "//h2/a[@href='/%s']/parent::h2/following-sibling::div[@class='add-info']//input[@title='Add to compare list']";
